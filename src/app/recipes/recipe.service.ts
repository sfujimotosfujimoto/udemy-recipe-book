...
export class RecipeService {
  ...
  private recipes: Recipe[] = [
    new Recipe('Curry', 'Very tasty', '../../assets/curry.jpg', [
      new Ingredient('French Fries', 2),
      new Ingredient('Pork Fries', 1)
    ]),
    new Recipe('Sushi', 'Good!', '../../assets/sushi.jpg', [
      new Ingredient('Squid', 4),
      new Ingredient('Rice', 5)
    ]),
    new Recipe('Takoyaki', 'The sauce!', '../../assets/takoyaki.jpg', [
      new Ingredient('Octopus', 2),
      new Ingredient('Flour', 3)
    ]),
    new Recipe('Sukiyaki', 'Very good!', '../../assets/sukiyaki.jpg', [
